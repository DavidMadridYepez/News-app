  ...
  return (
    <div className='font-serif pt-20 p-10 space-y-20 bg-black text-white'>
      ...
      <div className='flex justify-center md:justify-end space-x-5'>
        <a className='w-7' rel='noreferrer' target='_blank' href="https://github.com/DavidMadridYepez"><img src="./images/github (1).png" alt="" /></a>
        <a className='w-7' rel='noreferrer' target='_blank' href="https://porfolio-v1-pearl.vercel.app/"><img src="./images/briefcase.png" alt="" /></a>
        <a className='w-7' rel='noreferrer' target='_blank' href="https://www.linkedin.com/in/david-madrid-0809211a1/"><img src="./images/linkedin (1).png" alt="" /></a>
      </div>
    </div>
  )
}
